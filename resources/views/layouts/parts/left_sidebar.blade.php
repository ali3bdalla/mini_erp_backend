<div id="left">
    <div class="media user-media bg-dark dker">
        ...
        <div class="user-wrapper bg-dark">
            <a class="user-link" href="">
                <img class="media-object img-thumbnail user-img" alt="User Picture" src="{{ asset('backend/img/user.gif') }}">
    ...
    <ul id="menu" class="bg-blue dker">
        ...
        <li class="">
            <a href="{{ route('home') }}">
                <i class="fa fa-dashboard"></i><span class="link-title">&nbsp;{{ trans("layouts.dashboard") }}</span>
            </a>
        </li>
        <li class="nav-divider"></li>
        ...
        <li class="">
            <a href="{{ route('products.index') }}">
                <i class="fa fa-dashboard"></i><span class="link-title">&nbsp;{{ trans("layouts.products") }}</span>
            </a>
        </li>
        ...
        <li class="">
            <a href="{{ route('tags.index') }}">
                <i class="fa fa-dashboard"></i><span class="link-title">&nbsp;{{ trans("layouts.tags") }}</span>
            </a>
        </li>
